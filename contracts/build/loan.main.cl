...
// Definitions:
{
  "_reachr_Borrower_repay" = mem UInt,
  "_reachr_Lender_lend" = mem Bool,
  "_reachr_LoanViews_amountPaid" = mem UInt,
  "_reachr_LoanViews_loanPaid" = mem Bool
  }
// Functions:
{
  "Borrower_repay"(UInt )UInt = external(UInt) mut (v1080 : UInt* ) => {
    jump "_reacha_Borrower_repay"(v1080 : UInt ) Just Just "_reachr_Borrower_repay" },
  "Lender_lend"()Bool = external(Bool) mut () => {
    jump "_reacha_Lender_lend"() Just Just "_reachr_Lender_lend" },
  "LoanViews_amountPaid"()UInt = external(UInt) view () => {
    jump "_reacha_LoanViews_amountPaid"() Just Just "_reachr_LoanViews_amountPaid" },
  "LoanViews_loanPaid"()Bool = external(Bool) view () => {
    jump "_reacha_LoanViews_loanPaid"() Just Just "_reachr_LoanViews_loanPaid" },
  "_reacha_Borrower_repay"(UInt )Null = internal mut (v1080 : UInt* ) => {
    v1081 : UInt := state
    const v1083 : UInt! = 0;
    const v1082 : Tuple(UInt)! = [v1080 ];
    jump "_reachi_4"(v1083 : UInt, v1082 : Tuple(UInt) ) Nothing },
  "_reacha_Lender_lend"()Null = internal mut () => {
    v1084 : UInt := state
    const v1086 : UInt! = 0;
    const v1085 : Tuple()! = [];
    jump "_reachi_5"(v1086 : UInt, v1085 : Tuple() ) Nothing },
  "_reacha_LoanViews_amountPaid"()Null = internal view () => {
    v1076 : UInt := state
    const v1077 : Bool! = v1076 == 5;
    claim(CT_Enforce)(v1077, Just "Incorrect state: not leaf");
    [B/495 : Address*, tokCollateral/496 : Token*, tokLoan/497 : Token*, v513 : UInt*, lender/529 : Address*, endTime/622 : UInt*, amountPaid/623 : UInt*, thisConsensusTime/624 : UInt*, tokenInfos/630 : Array(Tuple(UInt, UInt, Bool), 2)*, netBalance/631 : UInt*, v654 : Bool*] := state5 True
    mem "_reachr_LoanViews_amountPaid" <- amountPaid/623
    exit() },
  "_reacha_LoanViews_loanPaid"()Null = internal view () => {
    v1078 : UInt := state
    const v1079 : Bool! = v1078 == 5;
    claim(CT_Enforce)(v1079, Just "Incorrect state: not leaf");
    [B/495 : Address*, tokCollateral/496 : Token*, tokLoan/497 : Token*, v513 : UInt*, lender/529 : Address*, endTime/622 : UInt*, amountPaid/623 : UInt*, thisConsensusTime/624 : UInt*, tokenInfos/630 : Array(Tuple(UInt, UInt, Bool), 2)*, netBalance/631 : UInt*, v654 : Bool*] := state5 True
    mem "_reachr_LoanViews_loanPaid" <- v654
    exit() },
  "_reachi_0"(Tuple(UInt, Token, Token, UInt, Object({"address": Address, "amount": UInt, "maturation": UInt, "principal": UInt})) )Null = internal mut (v1088 : Tuple(UInt, Token, Token, UInt, Object({"address": Address, "amount": UInt, "maturation": UInt, "principal": UInt}))* ) => {
    emitPublish(0, Tuple(UInt, Token, Token, UInt, Object({"address": Address, "amount": UInt, "maturation": UInt, "principal": UInt})) )
    {
      from = B/495 : Address,
      secs = thisConsensusSecs/501 : UInt,
      time = thisConsensusTime/500 : UInt
      } := txn.metadata
    const v1087 : UInt* = v1088[0];
    const tokCollateral/496 : Token* = v1088[1];
    const tokLoan/497 : Token* = v1088[2];
    const collateral/498 : UInt* = v1088[3];
    const loanInfo/499 : Object({"address": Address, "amount": UInt, "maturation": UInt, "principal": UInt})* = v1088[4];
    checkTime(v1087 : UInt )
    checkInterval(thisConsensusTime/500 : UInt, thisConsensusSecs/501 : UInt, (between [Nothing] [Nothing]) )
    const initialInfo/469 : Tuple(UInt, UInt, Bool)* = [0, 0, false ];
    const tokInfos/470 : Array(Tuple(UInt, UInt, Bool), 2)* = array(Tuple(UInt, UInt, Bool), [initialInfo/469, initialInfo/469 ]);
    const tokInfo/502 : Tuple(UInt, UInt, Bool)! = tokInfos/470[0];
    const tokInfo'/503 : Tuple(UInt, UInt, Bool)! = Tuple.set(tokInfo/502, 0, 0 );
    ...
    const v514 : Bool! = v512 < v513;
    claim(CT_Require)(v514, Nothing);
    state1 <- [(B/495 : Address, B/495), (tokCollateral/496 : Token, tokCollateral/496), (tokLoan/497 : Token, tokLoan/497), (collateral/498 : UInt, collateral/498), (loanInfo/499 : Object({"address": Address, "amount": UInt, "maturation": UInt, "principal": UInt}), loanInfo/499), (thisConsensusTime/500 : UInt, thisConsensusTime/500), (tokInfos'/508 : Array(Tuple(UInt, UInt, Bool), 2), tokInfos'/508), (v512 : UInt, v512), (v513 : UInt, v513)]
    exit() },
  "_reachi_1"(Tuple(UInt) )Null = internal mut (v1090 : Tuple(UInt)* ) => {
    emitPublish(1, Tuple(UInt) )
    {
      from = B/515 : Address,
      secs = thisConsensusSecs/517 : UInt,
      time = thisConsensusTime/516 : UInt
      } := txn.metadata
    [B/495 : Address*, tokCollateral/496 : Token*, tokLoan/497 : Token!, collateral/498 : UInt*, loanInfo/499 : Object({"address": Address, "amount": UInt, "maturation": UInt, "principal": UInt})!, thisConsensusTime/500 : UInt*, tokInfos'/508 : Array(Tuple(UInt, UInt, Bool), 2)*, v512 : UInt!, v513 : UInt!] := state1 False
    const v1089 : UInt* = v1090[0];
    checkTime(v1089 : UInt )
    checkInterval(thisConsensusTime/516 : UInt, thisConsensusSecs/517 : UInt, (between [Nothing] [Nothing]) )
    checkPay(0, None);
    const tokInfo/518 : Tuple(UInt, UInt, Bool)* = tokInfos'/508[0];
    const v519 : UInt! = tokInfo/518[0];
    const v520 : UInt! = v519 + collateral/498;
    ...
    claim(CT_Require)(v524, Just "sender correct");
    const endTime/528 : UInt! = thisConsensusTime/500 + 50;
    const lender/1091 : Address! = B/495;
    const loanAccepted/1092 : Bool! = false;
    const thisConsensusTime/1093 : UInt! = thisConsensusTime/516;
    const lastConsensusTime/1094 : UInt! = thisConsensusTime/500;
    const tokenInfos/1095 : Array(Tuple(UInt, UInt, Bool), 2)! = tokInfos'/523;
    const netBalance/1096 : UInt! = 0;
    jump "_reachl_2"(B/495 : Address, tokCollateral/496 : Token, tokLoan/497 : Token, loanInfo/499 : Object({"address": Address, "amount": UInt, "maturation": UInt, "principal": UInt}), v512 : UInt, v513 : UInt, endTime/528 : UInt, lender/1091 : Address, loanAccepted/1092 : Bool, thisConsensusTime/1093 : UInt, lastConsensusTime/1094 : UInt, tokenInfos/1095 : Array(Tuple(UInt, UInt, Bool), 2), netBalance/1096 : UInt ) Nothing },
  "_reachi_4"(Tuple(UInt, Tuple(UInt)) )Null = internal mut (v1103 : Tuple(UInt, Tuple(UInt))* ) => {
    emitPublish(4, Tuple(UInt, Tuple(UInt)) )
    {
      from = this/688 : Address,
      secs = thisConsensusSecs/691 : UInt,
      time = thisConsensusTime/690 : UInt
      } := txn.metadata
    [B/495 : Address*, tokCollateral/496 : Token!, tokLoan/497 : Token*, v513 : UInt*, lender/529 : Address!, endTime/622 : UInt!, amountPaid/623 : UInt*, thisConsensusTime/624 : UInt!, tokenInfos/630 : Array(Tuple(UInt, UInt, Bool), 2)*, netBalance/631 : UInt!, v654 : Bool#] := state5 False
    const v1102 : UInt* = v1103[0];
    const .fork192.msg/689 : Tuple(UInt)! = v1103[1];
    checkTime(v1102 : UInt )
    checkInterval(thisConsensusTime/690 : UInt, thisConsensusSecs/691 : UInt, (between [Nothing] [Nothing]) )
    setApiDetails("Borrower_repay", [Tuple(UInt)], None, AIC_SpreadArg );
    const amt/693 : UInt* = .fork192.msg/689[0];
    const v694 : Bool! = this/688 == B/495;
    claim(CT_Require)(v694, Just "You are not the Borrower");
    ...
    emitLog(api("Borrower_repay"))(amountPaid/623 );
    const amountPaid/732 : UInt! = amountPaid/623 + payAmt/724;
    const amountPaid/1104 : UInt! = amountPaid/732;
    const thisConsensusTime/1105 : UInt! = thisConsensusTime/690;
    const lastConsensusTime/1106 : UInt! = thisConsensusTime/624;
    const tokenInfos/1107 : Array(Tuple(UInt, UInt, Bool), 2)! = tokInfos'/713;
    const netBalance/1108 : UInt! = netBalance/631;
    jump "_reachl_3"(B/495 : Address, tokCollateral/496 : Token, tokLoan/497 : Token, v513 : UInt, lender/529 : Address, endTime/622 : UInt, amountPaid/1104 : UInt, thisConsensusTime/1105 : UInt, lastConsensusTime/1106 : UInt, tokenInfos/1107 : Array(Tuple(UInt, UInt, Bool), 2), netBalance/1108 : UInt ) Nothing },
  "_reachi_5"(Tuple(UInt, Tuple()) )Null = internal mut (v1110 : Tuple(UInt, Tuple())* ) => {
    emitPublish(5, Tuple(UInt, Tuple()) )
    {
      from = lender/561 : Address,
      secs = thisConsensusSecs/564 : UInt,
      time = thisConsensusTime/563 : UInt
      } := txn.metadata
    [B/495 : Address!, tokCollateral/496 : Token!, tokLoan/497 : Token*, loanInfo/499 : Object({"address": Address, "amount": UInt, "maturation": UInt, "principal": UInt})!, v512 : UInt*, v513 : UInt!, endTime/528 : UInt!, thisConsensusTime/531 : UInt!, tokenInfos/537 : Array(Tuple(UInt, UInt, Bool), 2)*, netBalance/538 : UInt!] := state7 False
    const v1109 : UInt* = v1110[0];
    v1110[1];
    checkTime(v1109 : UInt )
    checkInterval(thisConsensusTime/563 : UInt, thisConsensusSecs/564 : UInt, (between [Nothing] [Nothing]) )
    setApiDetails("Lender_lend", [Tuple()], None, AIC_SpreadArg );
    checkPay(0, None);
    const tokInfo/571 : Tuple(UInt, UInt, Bool)* = tokenInfos/537[1];
    const v572 : UInt! = tokInfo/571[0];
    ...
    const v577 : Bool! = true;
    emitLog(api("Lender_lend"))(v577 );
    const lender/1111 : Address! = lender/561;
    const loanAccepted/1112 : Bool! = true;
    const thisConsensusTime/1113 : UInt! = thisConsensusTime/563;
    const lastConsensusTime/1114 : UInt! = thisConsensusTime/531;
    const tokenInfos/1115 : Array(Tuple(UInt, UInt, Bool), 2)! = tokInfos'/576;
    const netBalance/1116 : UInt! = netBalance/538;
    jump "_reachl_2"(B/495 : Address, tokCollateral/496 : Token, tokLoan/497 : Token, loanInfo/499 : Object({"address": Address, "amount": UInt, "maturation": UInt, "principal": UInt}), v512 : UInt, v513 : UInt, endTime/528 : UInt, lender/1111 : Address, loanAccepted/1112 : Bool, thisConsensusTime/1113 : UInt, lastConsensusTime/1114 : UInt, tokenInfos/1115 : Array(Tuple(UInt, UInt, Bool), 2), netBalance/1116 : UInt ) Nothing },
  "_reachl_2"(Address, Token, Token, Object({"address": Address, "amount": UInt, "maturation": UInt, "principal": UInt}), UInt, UInt, UInt, Address, Bool, UInt, UInt, Array(Tuple(UInt, UInt, Bool), 2), UInt )Null = internal mut (B/495 : Address*, tokCollateral/496 : Token*, tokLoan/497 : Token*, loanInfo/499 : Object({"address": Address, "amount": UInt, "maturation": UInt, "principal": UInt})*, v512 : UInt*, v513 : UInt*, endTime/528 : UInt*, lender/529 : Address!, loanAccepted/530 : Bool*, thisConsensusTime/531 : UInt*, lastConsensusTime/532 : UInt*, tokenInfos/537 : Array(Tuple(UInt, UInt, Bool), 2)*, netBalance/538 : UInt* ) => {
    const v548 : Bool! = endTime/528 > lastConsensusTime/532;
    const v549 : Bool! = (loanAccepted/530 ? false : true);
    const v550 : Bool! = (v548 ? v549 : false);
    if v550 then {
      state7 <- [(B/495 : Address, B/495), (tokCollateral/496 : Token, tokCollateral/496), (tokLoan/497 : Token, tokLoan/497), (loanInfo/499 : Object({"address": Address, "amount": UInt, "maturation": UInt, "principal": UInt}), loanInfo/499), (v512 : UInt, v512), (v513 : UInt, v513), (endTime/528 : UInt, endTime/528), (thisConsensusTime/531 : UInt, thisConsensusTime/531), (tokenInfos/537 : Array(Tuple(UInt, UInt, Bool), 2), tokenInfos/537), (netBalance/538 : UInt, netBalance/538)]
      exit() }
    else {
      if loanAccepted/530 then {
        const tokInfo/609 : Tuple(UInt, UInt, Bool)* = tokenInfos/537[1];
        ...
        const deadline/620 : UInt! = loanInfo/499.maturation;
        const endTime/622 : UInt! = lastConsensusTime/532 + deadline/620;
        const amountPaid/1097 : UInt! = 0;
        const thisConsensusTime/1098 : UInt! = thisConsensusTime/531;
        const lastConsensusTime/1099 : UInt! = lastConsensusTime/532;
        const tokenInfos/1100 : Array(Tuple(UInt, UInt, Bool), 2)! = tokInfos'/619;
        const netBalance/1101 : UInt! = netBalance/538;
        jump "_reachl_3"(B/495 : Address, tokCollateral/496 : Token, tokLoan/497 : Token, v513 : UInt, lender/529 : Address, endTime/622 : UInt, amountPaid/1097 : UInt, thisConsensusTime/1098 : UInt, lastConsensusTime/1099 : UInt, tokenInfos/1100 : Array(Tuple(UInt, UInt, Bool), 2), netBalance/1101 : UInt ) Nothing }
      else {
        const tokInfo/585 : Tuple(UInt, UInt, Bool)! = tokenInfos/537[0];
        const v586 : UInt! = tokInfo/585[0];
        transfer.(v586, Some tokCollateral/496).to(B/495);
        transfer.(netBalance/538, None).to(B/495);
        Token.untrack(tokLoan/497)
        Token.untrack(tokCollateral/496)
        stateDestroy
        exit() }; }; },
  "_reachl_3"(Address, Token, Token, UInt, Address, UInt, UInt, UInt, UInt, Array(Tuple(UInt, UInt, Bool), 2), UInt )Null = internal mut (B/495 : Address*, tokCollateral/496 : Token*, tokLoan/497 : Token*, v513 : UInt*, lender/529 : Address*, endTime/622 : UInt*, amountPaid/623 : UInt*, thisConsensusTime/624 : UInt*, lastConsensusTime/625 : UInt!, tokenInfos/630 : Array(Tuple(UInt, UInt, Bool), 2)*, netBalance/631 : UInt* ) => {
    const v649 : Bool! = endTime/622 > lastConsensusTime/625;
    const v651 : Bool* = amountPaid/623 < v513;
    const v652 : Bool! = (v649 ? v651 : false);
    if v652 then {
      const v654 : Bool* = amountPaid/623 >= v513;
      state5 <- [(B/495 : Address, B/495), (tokCollateral/496 : Token, tokCollateral/496), (tokLoan/497 : Token, tokLoan/497), (v513 : UInt, v513), (lender/529 : Address, lender/529), (endTime/622 : UInt, endTime/622), (amountPaid/623 : UInt, amountPaid/623), (thisConsensusTime/624 : UInt, thisConsensusTime/624), (tokenInfos/630 : Array(Tuple(UInt, UInt, Bool), 2), tokenInfos/630), (netBalance/631 : UInt, netBalance/631), (v654 : Bool, v654)]
      exit() }
    else {
      const tokInfo/735 : Tuple(UInt, UInt, Bool)* = tokenInfos/630[0];
      const v736 : UInt* = tokInfo/735[0];
      ...
      stateDestroy
      exit() }; },
  "_reachp_0"(Tuple(UInt, Token, Token, UInt, Object({"address": Address, "amount": UInt, "maturation": UInt, "principal": UInt})) )Null = external(Null) mut (v1088 : Tuple(UInt, Token, Token, UInt, Object({"address": Address, "amount": UInt, "maturation": UInt, "principal": UInt}))* ) => {
    jump "_reachi_0"(v1088 : Tuple(UInt, Token, Token, UInt, Object({"address": Address, "amount": UInt, "maturation": UInt, "principal": UInt})) ) Just Nothing },
  "_reachp_1"(Tuple(UInt) )Null = external(Null) mut (v1090 : Tuple(UInt)* ) => {
    jump "_reachi_1"(v1090 : Tuple(UInt) ) Just Nothing },
  "_reachp_4"(Tuple(UInt, Tuple(UInt)) )Null = external(Null) mut (v1103 : Tuple(UInt, Tuple(UInt))* ) => {
    jump "_reachi_4"(v1103 : Tuple(UInt, Tuple(UInt)) ) Just Nothing },
  "_reachp_5"(Tuple(UInt, Tuple()) )Null = external(Null) mut (v1110 : Tuple(UInt, Tuple())* ) => {
    jump "_reachi_5"(v1110 : Tuple(UInt, Tuple()) ) Just Nothing }
  }
