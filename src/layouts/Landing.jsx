							...
							<div className={lg.comSocialContent}>
								...
								<div className={lg.comSocialDescription}>
									...
									>
										...
										P2PFinance by following us on Twitter. Get access to
										exclusive promotions, updates on new features, and valuable
										insights on the lending and borrowing industry. Follow us
										now and stay connected with P2PFinance community
									</span>
								</div>
							</div>
						</div>
							...
							<div className={lg.comSocialContent}>
								...
								<div className={lg.comSocialDescription}>
									<span
										className={cf(s.wMax, s.dInlineBlock, lg.comSocialDesText)}
									>
										Join our growing community on Discord and stay connected
										with the P2PFinance team and other users. Get real-time
										support, participate in discussions and events, and stay
										updated with the latest developments and updates on the
										platform. Join us now and be a part of the P2PFinance
										community.
									</span>
								</div>
							</div>
							...
							<div className={lg.comSocialContent}>
								...
								<div className={lg.comSocialDescription}>
									...
									>
										...
										directly, providing a marketplace and a secure smart
										contract to hold collateral in escrow. Sign up now and join
										the future of lending and borrowing, where no one is denied
